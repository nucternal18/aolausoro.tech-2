...
export const techSkillsData: TechSkillProps[] = [
  {
    name: 'HTML',
  ...
  {
    name: 'JetBrains',
    iconUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/jetbrains/jetbrains-original.svg',
  },
  {
    name: 'VSCode',
    iconUrl:
  ...
  {
    name: 'Redis',
    iconUrl: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/redis/redis-original-wordmark.svg',
  },
  {
    name: 'GraphQL',
    iconUrl:
