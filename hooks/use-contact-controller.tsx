...
import { createMessage, sendMail } from '@components/admin-route-components/actions/messages'
import { partialMessageSchema, type PartialMessageProps } from '@src/entities/models/Message'
...
export default function useContactController() {
  ...
  const handleSubmit: SubmitHandler<PartialMessageProps> = useCallback(async (data) => {
