...
export default async function Post({
  ...
  return (
    <section className="flex-grow h-full max-w-screen-lg mx-auto text-primary py-4">
      <Button asChild>
        <Link href="/blog" className="text-lg font-bold ">
          Go Back
        </Link>
      </Button>
      <section className="w-full px-10 py-6 mt-6 rounded-lg shadow-ld dark:shadow-lg ">
