...
export function createMessageUseCase(input: PartialMessageProps): Promise<ResponseProps> {
  return startSpan({ name: 'createMessage UseCase', op: 'function' }, async (span) => {
