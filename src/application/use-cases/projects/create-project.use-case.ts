...
export function createProjectUseCase(project: PartialProjectProps): Promise<ResponseProps> {
  return startSpan({ name: 'createProject UseCase', op: 'function' }, async (span) => {
