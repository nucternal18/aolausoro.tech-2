...
import { type PartialMessageProps, messageSchema } from '@src/entities/models/Message'
import { HumanValidationFailedError, InputParseError } from '@src/entities/errors/common'
