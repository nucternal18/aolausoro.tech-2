import { startSpan, captureException, withServerActionInstrumentation } from '@sentry/nextjs'
...
export class UsersRepository implements IUsersRepository {
  ...
  async updateUser(input: PartialUserProps): Promise<ResponseProps | undefined> {
