...
export class MessageRepository implements IMessageRepository {
  ...
  async getMessages(): Promise<PartialMessageProps[] | undefined> {
    return await startSpan({ name: 'MessageRepository > getMessages' }, async () => {
      try {
  ...
  async getMessageById(id: string): Promise<PartialMessageProps | undefined> {
    return await startSpan({ name: 'MessageRepository > getMessageById' }, async () => {
      try {
  ...
  async createMessage(input: PartialMessageProps & { userId: string }): Promise<ResponseProps> {
    return await startSpan({ name: 'MessageRepository > createMessage' }, async () => {
      try {
  ...
  async deleteMessage(id: string): Promise<ResponseProps> {
    return await startSpan({ name: 'MessageRepository > deleteMessage' }, async () => {
      try {
