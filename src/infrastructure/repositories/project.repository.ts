...
export class ProjectRepository implements IProjectRepository {
  ...
  async getProjects(): Promise<PartialProjectProps[] | undefined> {
    return await startSpan({ name: 'ProjectRepository > getProject' }, async () => {
      try {
  ...
  async getProjectById(id: string): Promise<PartialProjectProps | undefined> {
    return await startSpan({ name: 'ProjectRepository > getProjectById' }, async () => {
      try {
  ...
  async createProject(input: PartialProjectProps & { userId: string }): Promise<ResponseProps> {
    return await startSpan({ name: 'ProjectRepository > createProject' }, async () => {
      try {
  ...
  async updateProject(input: PartialProjectProps): Promise<ResponseProps> {
    return await startSpan({ name: 'ProjectRepository > updateProject' }, async () => {
      try {
  ...
  async deleteProject(id: string): Promise<ResponseProps> {
    return await startSpan({ name: 'ProjectRepository > deleteProject' }, async () => {
      try {
