...
export class IssueRepository implements IIssuesRepository {
  ...
  async getIssueById(id: string): Promise<PartialIssueProps | undefined> {
    return await startSpan({ name: 'IssueRepository -> getIssueById' }, async (span) => {
      try {
  ...
  async getIssues(): Promise<PartialIssueProps[]> {
    return await startSpan({ name: 'IssueRepository -> getIssues' }, async () => {
      try {
  ...
  async createIssue(userId: string, input: PartialIssueProps): Promise<ResponseProps> {
    return await startSpan({ name: 'IssueRepository -> createIssue' }, async () => {
      try {
  ...
  async updateIssue(input: PartialIssueProps): Promise<ResponseProps> {
    return await startSpan({ name: 'IssueRepository -> updateIssue' }, async () => {
      try {
  ...
  async deleteIssue(id: string): Promise<ResponseProps> {
    return await startSpan({ name: 'IssueRepository -> deleteIssue' }, async () => {
      try {
