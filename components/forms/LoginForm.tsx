  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        {errors.email && (
          <span id="email-error" className="text-red-600 dark:text-yellow-500">
        ...
        <div className="mb-4 w-full bg-white flex gap-1 p-1 rounded-md">
          <label
            ...
            htmlFor="password"
          />
          <div className="flex w-full px-3 py-2 leading-tight text-gray-700 border-none appearance-none focus:outline-none  focus:ring-0 bg-white">
            <input
              className="w-full px-3 py-2 leading-tight text-gray-700 border-none appearance-none focus:outline-none  focus:ring-0 bg-white"
        ...
        {errors.password && (
          <span
            id="password-error"
            className="text-red-600 dark:text-yellow-500"
          >
