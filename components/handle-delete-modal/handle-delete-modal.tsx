...
export default function HandleDeleteModal({
  ...
  return (
    <AlertDialog>
      <AlertDialogTrigger
        className={cn(
          `flex w-full items-center justify-start border-gray-900 px-4 py-2 dark:border-gray-200`,
          className,
        )}
      >
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={() => deleteHandler(id)}>Continue</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
  )
