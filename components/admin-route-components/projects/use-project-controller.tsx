...
import {
  setImage,
  projectSelector,
} from '@components/admin-route-components/global-redux-store/features/projects/projectsSlice'
...
import {
  ...
  deleteProject,
  updateProject,
} from '@components/admin-route-components/actions/projects'
import { partialProjectSchema, type PartialProjectProps } from '@src/entities/models/Project'
