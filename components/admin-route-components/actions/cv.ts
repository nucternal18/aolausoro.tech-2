...
import { createCvController, getCvsController } from '@src/interface-adapters/controllers/cv'

export async function getCV() {
  return await withServerActionInstrumentation('getCV', { recordResponse: false }, async () => {
    try {
...
export async function createCV(requestBody: FormData) {
  return await withServerActionInstrumentation('createCV', { recordResponse: true }, async () => {
