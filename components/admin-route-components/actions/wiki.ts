...
> {
  return await withServerActionInstrumentation('getWiki', { recordResponse: true }, async () => {
...
export async function createWiki(input: FormData): Promise<{ success: boolean; message: string }> {
  return await withServerActionInstrumentation('createWiki', { recordResponse: true }, async () => {
    const { userId } = await auth()
    try {
...
export async function updateWiki(input: FormData): Promise<{ success: boolean; message: string }> {
  return await withServerActionInstrumentation('updateWiki', { recordResponse: true }, async () => {
    const { userId } = await auth()
    try {
      const formData = Object.fromEntries(input.entries())
...
export async function deleteWiki(id: string): Promise<{ success: boolean; message: string }> {
  return await withServerActionInstrumentation('deleteWiki', { recordResponse: true }, async () => {
    const { userId } = await auth()
    try {
