  ...
  return (
    <Card className="container mx-auto w-full">
      <CardContent className="space-y-4 pt-4">
        <FormField
          ...
          render={({ field }) => (
            <div {...getRootProps()} className="space-y-4">
              <div className="flex cursor-pointer items-center justify-center gap-2 rounded-md border-2 border-dashed border-gray-300 p-8 hover:border-gray-400 dark:border-gray-600 dark:hover:border-gray-500">
                <label
                  className="mb-2 flex items-center space-x-2 text-sm font-bold text-gray-700 capitalize"
                  htmlFor={name}
                >
                ...
                <Input type="file" accept="image/png, image/jpeg" id={name} {...getInputProps()} />
              </div>
        ...
        <div
          className={
            'w-full rounded-md border-2 border-dashed border-gray-300 p-2 hover:border-gray-400 dark:border-gray-600 dark:hover:border-gray-500' +
        ...
        >
          ...
          {!!files?.length && (
            <div className="relative mt-2 grid grid-cols-1 gap-1 sm:grid-cols-2 md:grid-cols-3">
              {files.map((file) => {
                ...
                return (
                  ...
                  >
                    <Typography className="text-primary/80">{file.name}</Typography>
                    <Typography className="text-primary/80">{file.size} bytes</Typography>
                  </div>
                )
              })}
            </div>
